...
const MyStack = () => {
  let [loged,setLoged]=useState(true)
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName={(loged==false)?"allProducts":"home"}>
        <Stack.Screen
          name="home"
          component={Tabs}
          options={{
        ...
        <Stack.Screen name="firstlog" component={firstLog} options={{title="moasko"}}/>

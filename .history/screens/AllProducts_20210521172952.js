...
const Pagination = () => {
    let f =[]
for (let i = 1; i < 5; i++) {
   f.push(<TouchableOpacity key={i} style={{width:40,height:30,justifyContent:"center",alignItems:"center",flex:1}}><Text style={{backgroundColor:"red",color:"#fff"}}>{i}</Text></TouchableOpacity>)
}

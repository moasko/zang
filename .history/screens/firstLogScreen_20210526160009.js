...
const firstLog = () => {
    ...
    return <View style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "#ff6200" }}>
        ...
        />
        <Text style={{ textAlign: "center", color: "#fff", fontSize:17,padding:5 }}>veillez entre votre nom SVP et recevez un cadeau apres votre dexieme achat sur notre application</Text>
        <TextInput
            style={styles.input}
        ...
        <TouchableOpacity style={{ width: "100%", alignItems: "center" }}>
            <View style={{ width: "90%", backgroundColor: "#fff", padding: 18, borderRadius: 5, marginTop: 35 }}>
                <Text style={{color:"#ff6200",fontSize:18,textAlign:"center"}}>recevoir</Text>
            </View>
        </TouchableOpacity>
    </View>;
}

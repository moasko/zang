...
const firstLog = () => {
    ...
    return <View style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "#ff6200" }}>
        ...
        <Text style={{ width:"80%", color: "#fff", fontSize: 25, fontWeight: "700" }}>BIENVENUE CHEZ VOUS </Text>
        <Image
            style={{
                height: 100,
                width: 200,
        ...
        />
        <Text style={{ backgroundColor:"red", textAlign: "center", color: "#fff", fontSize:17,padding:5 }}>veillez entre votre nom SVP et recevez un cadeau apres votre dexieme achat sur notre application</Text>
        <TextInput
            style={styles.input}

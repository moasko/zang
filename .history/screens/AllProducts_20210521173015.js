...
const Pagination = () => {
    let f =[]
for (let i = 1; i < 5; i++) {
   f.push(<TouchableOpacity key={i} style={{justifyContent:"center",alignItems:"center",flex:1}}><Text style={{width:40,height:30,backgroundColor:"red",color:"#fff"}}>{i}</Text></TouchableOpacity>)
}

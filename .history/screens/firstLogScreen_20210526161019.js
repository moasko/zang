...
const firstLog = () => {
    ...
    return <View style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "#ff6200" }}>
        ...
        />
        <Text style={{width:"90%",borderRadius:6, backgroundColor:"#0000005c", textAlign: "center", color: "#fff", fontSize:17,padding:10 }}>veillez entre votre nom SVP et recevez un cadeau apres votre dexieme achat sur notre application</Text>
        <TextInput
            style={styles.input}

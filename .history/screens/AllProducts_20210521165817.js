...
const Pagination = () => {
    let f =[]
for (let i = 0; i < 5; i++) {
   f.push(<TouchableOpacity style={{width:40,height:40,margin:6,justifyContent:"center",alignItems:"center"}}><Text style={{padding:10,backgroundColor:"red",color:"#fff"}}>{i}</Text></TouchableOpacity>)
}

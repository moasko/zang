...
const firstLog = () => {
    ...
    return <View style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "#ff6200" }}>
        ...
        />
        <Text style={{ textAlign: "center", color: "#fff", fontSize:17 }}>veillez entre votre nom SVP et recevez un cadeau apres votre dexieme achat sur notre application</Text>
        <TextInput
            style={styles.input}

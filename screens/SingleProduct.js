...
function SingleProduct({ route }) {
  ...
  const { id, url, name, prix, preprix, categories, permalink, description } =
    parametters;
      ...
      <>
        <ScrollView>
          ...
          <View style={{ padding: 20 }}>
            ...
            >
              <Text
                style={{
                  color: "#000",
                  fontWeight: "bold",
                  width: PARAMS.SCREEN_WIDTH / 2 + 20,
                  fontSize: 20,
                }}
              >
                {name}
              ...
              <Text
                style={{ color: "#e76300", fontSize: 20, fontWeight: "bold" }}
              >
                {prix} {PARAMS.DEVIS}
              </Text>
            </View>
            ...
            <HTML
              source={{
                html: `${description}` || "<code>Aucune description</code>",
              }}
              contentWidth={PARAMS.SCREEN_WIDTH}
              tagsStyles={{
                ul: {
                  padding: 0,
                  margin: 0,
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
          ...
          <Pressable onPress={() => Linking.openURL(`tel:+2252521003875`)}>
            <View
              style={{
